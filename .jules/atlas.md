...
## 2026-07-01 - Splitting Temporal Vector Index Blob
...
**Blueprint:** Refactored tests into `src/index/vector/temporal/tests.rs`, maintaining the `#[cfg(test)]` block functionality but with better physical separation. Kept the core data definitions and implementation in `mod.rs` (reduced to ~1400 lines).

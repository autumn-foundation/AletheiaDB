...
## 2026-06-21 - Splitting Id God Module
**Tangle:** `src/core/id.rs` was a ~2000 line "Blob" containing both core domain primitives and extensive tests, making it difficult to maintain and navigate.
**Blueprint:** Refactored into `src/core/id/` directory, extracting all tests into `tests.rs` to separate concerns while maintaining `#[cfg(test)]` block functionality.

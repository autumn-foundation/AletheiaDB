...
fn test_adaptive_overfetch_statistics_tracking() {
    ...
    // Get initial stats (if API available)
    // This test verifies the internal tracking works correctly
    ...
    // The adaptive strategy should have recorded ~10 searches for label "A"
    // and learned that it has a ~50% pass rate
    // This is verified implicitly by the quality of subsequent searches
}

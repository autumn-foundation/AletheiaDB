...
**Issue:** [perf(hnsw): Vec allocation on every add() and search() call](https://github.com/autumn-foundation/AletheiaDB/issues/232)
...
| 2026-01-14 | **Migration to `usearch`** completed ([PR #403](https://github.com/autumn-foundation/AletheiaDB/pull/403)) |
...
- Issue #232: https://github.com/autumn-foundation/AletheiaDB/issues/232
- PR #403 (usearch migration): https://github.com/autumn-foundation/AletheiaDB/pull/403

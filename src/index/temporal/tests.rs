use crate::index::temporal::timeline::EntityTimelines;
use crate::index::temporal::metadata::VersionMetadataIndex;
use super::*;
use crate::core::temporal::{BiTemporalInterval, TIMESTAMP_MAX};
use crate::core::id::{EdgeId, NodeId, VersionId};
use crate::core::temporal::TimeRange;
use crate::core::id::EntityId;
use crate::index::temporal::timeline::TimelineEntry;
use crate::index::temporal::metadata::TimelineVersionMetadata; // Renamed

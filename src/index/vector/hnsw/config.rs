//! HNSW index configuration and builder.
//!
//! This module defines the `HnswConfig` struct and the `HnswIndexBuilder` for creating
//! and configuring HNSW indexes. It also contains helper functions for mapping
//! between AletheiaDB's internal types and the `usearch` library types.

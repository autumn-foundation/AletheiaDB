...
/// Macro to generate inherent methods delegating to ReadOps.
///
/// This reduces boilerplate in transaction implementations.
#[macro_export]
macro_rules! inherent_read_ops {
    () => {
        /// Get a node by ID.
...
/// Macro to generate inherent methods delegating to WriteOps.
///
/// This reduces boilerplate in WriteTransaction.
#[macro_export]
macro_rules! inherent_write_ops {
    () => {
        /// Create a new node.

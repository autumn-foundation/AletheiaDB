use crate::core::vector::ops::{cosine_similarity, dot_product, euclidean_distance};
...
pub enum DistanceMetric {
    ...
    /// # Implementation Note
    ///
    /// Uses [`crate::core::vector::cosine_similarity`] internally, which handles zero vectors
    ...
    /// # Implementation Note
    ///
    /// Uses [`crate::core::vector::euclidean_distance`] internally, which uses SIMD-accelerated

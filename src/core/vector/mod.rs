...
//! [`PropertyValue::Vector`](crate::core::PropertyValue::Vector). This module provides the utilities needed
...
//! # Design Notes
//!
//! Vectors in GallifreyDB are stored as `Arc<[f32]>` within [`PropertyValue::Vector`](crate::core::PropertyValue::Vector).
//! This design enables:
//!
...
/// Vector constants (tolerances, thresholds, max dimensions).
pub mod constants;
/// Similarity and distance metrics.
pub mod metric;
/// Core vector operations (normalization, dot product).
pub mod ops;
/// SIMD implementation details (internal).
pub(crate) mod simd;
...
// Re-export constants
pub use constants::{MAX_DIMENSION, NORMALIZATION_TOLERANCE};

// Re-export types
pub use types::VectorDimension;

// Re-export sparse vector types
pub use sparse::SparseVec;

// Re-export validation functions
pub use validation::{check_dimensions_match, validate_vector, validate_vector_with_bounds};

// Re-export operations
pub use ops::{
    dot_product, is_normalized, is_normalized_default, magnitude, normalize, normalize_in_place,
    squared_magnitude,
};

// Re-export metrics and similarity functions
pub use metric::{
    cosine_similarity, cosine_similarity_normalized, euclidean_distance,
    squared_euclidean_distance, DistanceMetric,
};

// Re-export sparse vector similarity functions
pub use sparse::{

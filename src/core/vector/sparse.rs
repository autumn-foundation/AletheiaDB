...
mod tests {
    ...
    fn test_sparse_squared_euclidean_distance_tail_coverage() {
        ...
        let a = SparseVec::new(vec![0], vec![2.0], 3).unwrap();
        let b = SparseVec::new(vec![], vec![], 3).unwrap();

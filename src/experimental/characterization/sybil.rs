...
impl PropagationModel {
    ...
    pub fn next_state(
        ...
        match self {
            Self::Linear(model) => model.next_state(node_id, current_self, neighbors),
            Self::Wildfire(model) => model.next_state(node_id, current_self, neighbors),
        }
    }
}
...
mod tests {
    ...
    fn test_wildfire_propagation() {
        ...
        let model = PropagationModel::Wildfire(WildfirePropagation::new(temps, 0.0, 0.1));

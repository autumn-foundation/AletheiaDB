...
//! let aspects = chameleon.analyze_context(NodeId::try_from(123).unwrap(), "embedding", 2)?;
//!
...
//! let results = chameleon.facet_search(NodeId::try_from(123).unwrap(), "embedding", 0, 10)?;
//!

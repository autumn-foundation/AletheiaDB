...
pub enum NetworkError {
    /// Connection failed.
    ConnectionFailed {
        /// The shard ID that failed to connect.
        shard_id: ShardId,
        /// Reason for failure.
        reason: String,
    },
    ...
    CircuitOpen {
        /// The shard ID whose circuit is open.
        shard_id: ShardId,
        /// The time remaining until circuit will half-open.
        remaining: Duration,
    },
    ...
    PoolExhausted {
        /// The shard ID whose connection pool is exhausted.
        shard_id: ShardId,

...
pub enum MigrationError {
    ...
    ChecksumMismatch {
        /// The batch number that failed checksum validation.
        batch_number: u64,
    ...
    /// Migration timed out.
    Timeout {
        /// The migration ID that timed out.
        migration_id: u64,
    ...
    InvalidState {
        /// The migration ID experiencing state transition failure.
        migration_id: u64,
    ...
    /// Verification failed.
    VerificationFailed {
        /// The migration ID that failed verification.
        migration_id: u64,

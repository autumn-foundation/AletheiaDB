// use super::*;
    ...
    #[test]
    fn test_checkpoint_creation_basic() -> crate::core::error::Result<()> {
    ...
    #[test]
    fn test_checkpoint_persists_graph_data() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig::with_data_dir(temp_dir.path());
        let mut manager = CheckpointManager::new(config)?;
    ...
    #[test]
    fn test_checkpoint_recovery_loads_state() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
    ...
    #[test]
    fn test_checkpoint_recovery_with_wal_replay() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_lsn_consistency() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig::with_data_dir(temp_dir.path());
        let mut manager = CheckpointManager::new(config)?;
    ...
    #[test]
    fn test_should_checkpoint_logic() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
    ...
    #[test]
    fn test_recovery_without_persisted_state() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_checkpoint_with_compression() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig {
            data_dir: temp_dir.path().to_path_buf(),
    ...
    #[test]
    fn test_has_persisted_state() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig::with_data_dir(temp_dir.path());
        let mut manager = CheckpointManager::new(config)?;
    ...
    #[test]
    fn test_checkpoint_preserves_properties() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_compression_disabled_ignores_level() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig {
            data_dir: temp_dir.path().to_path_buf(),
    ...
    #[test]
    fn test_checkpoint_without_compression() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_checkpoint_with_edges() -> crate::core::error::Result<()> {
    ...
    #[test]
    fn test_checkpoint_lsn_ahead_of_wal_error() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_wal_replay_create_edge() -> crate::core::error::Result<()> {
        use crate::core::id::EdgeId;
    ...
    #[test]
    fn test_wal_replay_update_node() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_wal_replay_update_edge() -> crate::core::error::Result<()> {
        use crate::core::id::EdgeId;
    ...
    #[test]
    fn test_wal_replay_delete_node() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_wal_replay_delete_edge() -> crate::core::error::Result<()> {
        use crate::core::id::EdgeId;
    ...
    #[test]
    fn test_wal_replay_checkpoint_marker() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_checkpoint_with_temporal_node_versions() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_checkpoint_with_temporal_edge_versions() -> crate::core::error::Result<()> {
        use crate::core::graph::Edge;
        use crate::core::id::EdgeId;
    ...
    #[test]
    fn test_get_persisted_lsn_none() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig::with_data_dir(temp_dir.path());
    ...
    #[test]
    fn test_checkpoint_updates_tracking() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig::with_data_dir(temp_dir.path());
        let mut manager = CheckpointManager::new(config)?;
    ...
    #[test]
    fn test_should_checkpoint_time_threshold() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig {
            data_dir: temp_dir.path().to_path_buf(),
    ...
    #[test]
    fn test_checkpoint_with_closed_valid_time() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_recovery_id_generator_initialization() -> crate::core::error::Result<()> {
        use crate::core::graph::Edge;
        use crate::core::id::EdgeId;
    ...
    #[test]
    fn test_wal_replay_updates_id_generators() -> crate::core::error::Result<()> {
        use crate::core::id::EdgeId;
    ...
    #[test]
    fn test_checkpoint_stats_fields() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let config = CheckpointConfig::with_data_dir(temp_dir.path());
        let mut manager = CheckpointManager::new(config)?;
    ...
    #[test]
    fn test_recovery_historical_version_id_tracking() -> crate::core::error::Result<()> {
        let temp_dir = TempDir::new().unwrap();
        let wal_dir = temp_dir.path().join("wal");
        let data_dir = temp_dir.path().join("data");
    ...
    #[test]
    fn test_recovery_with_no_cold_storage() -> crate::core::error::Result<()> {
    ...
    #[test]
    fn test_recovery_with_checkpoint_no_cold_storage() -> crate::core::error::Result<()> {
    ...
    #[test]
    fn test_recovery_loads_cold_storage_first() -> crate::core::error::Result<()> {
    ...
    #[test]
    fn test_recovery_replays_wal_from_flushed_lsn() -> crate::core::error::Result<()> {
        use crate::storage::redb_cold_storage::{RedbColdStorage, RedbConfig};
    ...
    #[test]
    fn test_recovery_with_no_wal_segments() -> crate::core::error::Result<()> {
        use crate::storage::redb_cold_storage::{RedbColdStorage, RedbConfig};
    ...
    #[test]
    fn test_recovery_validates_lsn_consistency() -> crate::core::error::Result<()> {
        use crate::storage::redb_cold_storage::{RedbColdStorage, RedbConfig};

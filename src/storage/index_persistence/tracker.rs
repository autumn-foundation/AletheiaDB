//! Persistence state tracker.
//!
//! This module provides the `PersistenceTracker` struct which monitors
//! mutations and time elapsed since last persistence for various index types.

//! High-level index persistence operations.
//!
//! This module coordinates the persistence of various index types:
//! - Vector indexes
//! - Graph index (adjacency)
//! - Temporal index (version history)
//! - String interner
...
pub fn persist_vector_indexes(
    ...
    use super::formats::PersistedHnswConfig;
    use super::vector::{
...
pub fn load_vector_indexes(
    ...
    use super::vector::{load_vector_mappings, load_vector_meta};
...
pub fn persist_graph_index(
    ...
    use super::graph::{new_graph_index_data, persist_property_map, save_graph_index};
    use super::{PersistedEdge, PersistedNode};
...
pub fn persist_all_indexes(
    ...
    // Save manifest
    use super::formats::{GraphIndexManifestEntry, IndexManifest, StringInternerManifestEntry};

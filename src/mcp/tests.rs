...
mod list_nodes_extended_tests {
    ...
    fn test_parse_args_invalid_argument() {
        ...
        for _tool in tools {
            ...
            let result: Result<crate::mcp::GetNodeRequest, _> =
                server.parse_args(invalid_args.clone());

...
mod node_tests {
    ...
    fn test_invalid_argument_parsing() {
        ...
        let get_node_err = server.handle_get_node(json!({ "limit": "not-a-number", "node_id": "not-a-number", "edge_id": "not-a-number", "label": 123, "start_node_id": "not-a-number", "query": 123, "property_key": 123, "property_value": 123, "properties": 123, "from_node": "not-a-number", "to_node": "not-a-number" }));
